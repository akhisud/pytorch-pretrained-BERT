...
def main():
    ...
    parser.add_argument("--load_trained", action='store_true', help="Load trained model and train over it.")
    ...
    spl_tokens = {'cont_start': '<CONT_START>',
                  ...
                  'end': '<END>'}
    special_tokens = [spl_tokens[i] for i in spl_tokens.keys()]
    tokenizer = OpenAIGPTTokenizer.from_pretrained(args.model_name, special_tokens=special_tokens)
    start_token_id = tokenizer.convert_tokens_to_ids(['<DATA_START>'])[0]
    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            if args.do_eval:
                ...
                output_eval_file = os.path.join(args.output_dir, "eval_results_{}.txt".format(str(ep_count)))
